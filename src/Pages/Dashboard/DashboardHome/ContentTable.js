        ...
        <>
            {
                loading ? <LoadingStatus status={status} /> : (
                    (!tableDocuments?.investmentPension && !tableDocuments?.insurance) ? (<div className='text-center text-gray-400 mt-5 font-semibold'>Admin has not uploaded any documents yet</div>) : (
                        <div className=''>
                                    ...
                                    <div className="row-userdata">
                                        ...
                                        <div className="col-lg-6-userdata">
                                            <div class="p-4 max-w-md bg-white rounded-lg border border-blue-500 shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700 mt-5">
                                                <div class="flex justify-between items-center mb-4">
                                                    <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white underline underline-offset-2">INVESMENT & PENSIONS</h5>
                                        ...
                                        <div className="col-lg-6-userdata">
                                            <div class="p-4 max-w-md bg-white rounded-lg border border-green-500 shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700 mt-5">
                                                <div class=" mb-4">
                                                    <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white underline underline-offset-2">INSURANCE</h5>
